package com.lzy.mywheels.ExcelRead.superfileview;
...
import com.lzy.mywheels.App.TLog;
...
public class QQReadOfficeActivity extends AppCompatActivity {
    private static final String TAG = "QQReadOfficeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qqread_office);
    ...
    private void read() {
        ...
        switch (sign){
            case 1:
                filePath = "http://qq.test.51zhiyuan.net/file/二 金官换流站电力监控系统介绍-1 概述.docx";
                break;
            case 2:
                filePath = "http://qq.test.51zhiyuan.net/file/腾讯软件PPT.pptx";
                break;
            case 3:
                filePath = "http://qq.test.51zhiyuan.net/file/三 电力监控系统安全系统安全防护要求-1 管理安全.xlsx";
                break;
        }
        if (!EasyPermissions.hasPermissions(this, perms)) {
            EasyPermissions.requestPermissions(
                    QQReadOfficeActivity.this, "需要访问手机存储权限！", 10086, perms);
        } else {
    ...
    private File getCacheFile(String url) {
        ...
        File s = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/10086");
        if (!s.exists()) {
            s.mkdirs();
        }

        File cacheFile = new File(s +"/"+ getFileName(url));
